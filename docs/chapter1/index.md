...
## 1.1 蛋白质的核心生物学功能
蛋白质作为生命系统的核心功能分子，其生物学作用贯穿于生命活动的所有关键维度，是维系机体结构完整、代谢有序、信号通畅与环境适应的基础。这些功能的实现均依赖于蛋白质独特的氨基酸序列与三维构象 —— 特定的结构域（如活性中心、结合位点）赋予其分子识别能力，构象的动态变化支撑其功能状态的切换，而结构的稳定性则保障功能的持续发挥。

### 四种主要的生物化学功能：
1.  **催化功能（酶）**
    酶是高效生物催化剂，可加速反应速率高达$10^{12}$倍。其催化特异性源于活性中心的精确三维结构，如葡萄糖激酶对葡萄糖的特异性识别依赖于其活性中心精确匹配葡萄糖立体构型的结合口袋。评估酶模型质量时，需特别关注活性中心残基的**空间排列**是否允许底物结合和催化反应进行。

2.  **结构支持功能**
    结构蛋白构成细胞骨架网络和细胞外基质，如胶原蛋白三股螺旋提供组织**拉伸**强度，微管蛋白聚合形成细胞分裂所需的纺锤体。结构蛋白模型需评估其**聚合界面和力学特性**。
...
## 1.2 蛋白质的结构层次体系
蛋白质的结构层次体系是其从氨基酸序列到功能构象的递进式组织形态，各级结构既相互独立又紧密关联，共同支撑起蛋白质的空间特征与生物学活性基础。这种层次化构建遵循 “线性基础→局部有序→全局折叠→多亚基组装” 的核心逻辑，每一级结构均由特定的化学作用力与空间约束所维系（更多内容可见第四章）。
...
对于模型质量评估初学者，建议从RCSB PDB数据库（[https://www.rcsb.org/](https://www.rcsb.org/)）中下载典型蛋白质的结构文件，使用**PyMOL**或**ChimeraX**等可视化软件直观观察不同层次的结构特征，并结合上述评估工具进行实践分析。
